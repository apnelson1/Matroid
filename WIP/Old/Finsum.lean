...
theorem finprod_mem_le_finprod_mem' [OrderedCommMonoid N] (hf : (s ∩ mulSupport f).Finite)
  ...
  · rw [hs', inter_assoc, inter_eq_self_of_subset_right subset_union_right]
  rw [hs', inter_assoc, inter_eq_self_of_subset_right subset_union_left]
...
--   · rw [← finsum_mem_inter_support, h' (c ∩ support ncard) (hc.subset inter_subset_left)
...
--   rw [hs', ← inter_distrib_left, inter_assoc, inter_eq_self_of_subset_right subset_union_left]
...
--     · rw [← inter_distrib_left, inter_assoc, inter_eq_self_of_subset_right subset_union_left]
--     rw [← inter_distrib_left, inter_assoc, inter_eq_self_of_subset_right subset_union_left]
