import Matroid.SimpGraph.Basic

variable {α β : Type*} {x y z u v w : α} {a b c d : β} {e f : Sym2 β} {G H K : Graph α β}
  {F F₁ F₂ : Set (Sym2 β)} {X Y : Set α}

open Set GraphLike SimpleGraph
...
instance : PartialOrder (Graph α β) where
  ...
  le_antisymm G H h₁ h₂ := Graph.ext (h₁.1.antisymm h₂.1) sorry sorry
