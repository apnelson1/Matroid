...
lemma sUnion_compatible_sUnion_of_subset (hs : Gs.Pairwise Compatible) (hs' : Gs.Pairwise Dup_agree)
...
protected lemma inter_distrib_sUnion (hs : Gs.Pairwise Compatible) (hs' : Gs.Pairwise Dup_agree) :
