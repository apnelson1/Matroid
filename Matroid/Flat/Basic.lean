...
lemma Flat.rk_insert_eq_add_one (hF : M.Flat F) (hfin : M.IsRkFinite F) (he : e ∈ M.E \ F) :
...
lemma Flat.rk_lt_of_superset (hF : M.Flat F) (hFX : F ⊂ X) (hfin : M.IsRkFinite X)
...
lemma Flat.iInter_mem_of_directed_of_isRkFinite {ι : Type*} {F : ι → Set α} (hF : ∀ i, M.Flat (F i))
